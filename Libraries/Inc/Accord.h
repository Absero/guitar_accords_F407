...
#define FRET_INC3 FRET_INC*FRET_INC*FRET_INC
#define FRET_INC7 FRET_INC3*FRET_INC3*FRET_INC
// @formatter:off
static std::map<std::string, std::vector<float>> CHORD = {
		{ "A", { 110, 165, 220, 277, 329} },
		{ "B", { 123, 185, 247, 311, 370} },
		{ "C", { 131, 165, 196, 262, 329 } },
		{ "D", { 147, 220, 294, 370 } },
		...
		{ "Am7", {98, 110, 165, 196, 262, 329} },
		{ "Em7", {123, 147, 247, 294, 370} },

		{ "1C", { 131*FRET_INC, 165*FRET_INC, 196*FRET_INC, 262*FRET_INC, 329*FRET_INC } },
		{ "1Fm", {87*FRET_INC, 131*FRET_INC, 175*FRET_INC, 208*FRET_INC, 262*FRET_INC, 349*FRET_INC} },
		{ "1F", { 87*FRET_INC, 131*FRET_INC, 175*FRET_INC, 220*FRET_INC, 262*FRET_INC, 349*FRET_INC} },
		...
		{ "3G", { 98*FRET_INC3, 123*FRET_INC3, 147*FRET_INC3, 196*FRET_INC3, 247*FRET_INC3, 392*FRET_INC3} },
		{ "3C", { 131*FRET_INC3, 165*FRET_INC3, 196*FRET_INC3, 262*FRET_INC3, 329*FRET_INC3 } },
		{ "3Am", {110*FRET_INC3, 165*FRET_INC3, 220*FRET_INC3, 262*FRET_INC3, 329*FRET_INC3} },
		{ "3D7", {147*FRET_INC3, 220*FRET_INC3, 262*FRET_INC3, 370*FRET_INC3} },
		{ "3D", { 147*FRET_INC3, 220*FRET_INC3, 294*FRET_INC3, 370*FRET_INC3 } },
		{ "3A7", {110*FRET_INC3, 165*FRET_INC3, 196*FRET_INC3, 277*FRET_INC3, 329*FRET_INC3} },

		{ "7G", { 98*FRET_INC7, 123*FRET_INC7, 147*FRET_INC7, 196*FRET_INC7, 247*FRET_INC7, 392*FRET_INC7} },
		{ "7Am", {110*FRET_INC7, 165*FRET_INC7, 220*FRET_INC7, 262*FRET_INC7, 329*FRET_INC7} },
		{ "7C", { 131*FRET_INC7, 165*FRET_INC7, 196*FRET_INC7, 262*FRET_INC7, 329*FRET_INC7 } },
		{ "7Em", {82*FRET_INC7, 123*FRET_INC7, 165*FRET_INC7, 196*FRET_INC7, 247*FRET_INC7, 329*FRET_INC7} },

		{ "8F", { 87*FRET_INC7*FRET_INC, 131*FRET_INC7*FRET_INC, 175*FRET_INC7*FRET_INC, 220*FRET_INC7*FRET_INC, 262*FRET_INC7*FRET_INC, 349*FRET_INC7*FRET_INC} },
