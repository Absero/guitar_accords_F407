...
const osThreadAttr_t AccordTask_attributes = {
  .name = "AccordTask",
  .cb_mem = &taskAccordControlBlock,
  .cb_size = sizeof(taskAccordControlBlock),
  .stack_mem = &taskAccordBuffer[0],
  .stack_size = sizeof(taskAccordBuffer),
